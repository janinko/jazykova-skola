...
/**
 * LectionDAO does CRUD operations with the Lection entity.
 * It can store lections to the database, update, retrieve and delete them.
 * It allows to retrieve lections by course.
 * @author xchrastk
 */
